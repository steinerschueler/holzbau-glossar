...
quellen_primär:
  ...
  - "DIN EN ISO 6946:2018-03 'Bauteile – Wärmedurchlasswiderstand und Wärmedurchgangskoeffizient – Berechnungsverfahren', Abschnitt 6 (U = 1/(R_si + ΣR + R_se)), Abschnitt 8 (Grenzwertverfahren für inhomogene Bauteile)."
  - "SIA 180:2014 'Wärmeschutz, Feuchteschutz und Raumklima in Gebäuden', Begriffsabschnitt und Anforderung 'durchgehende thermische Gebäudehülle'."
  - "SIA 380/1:2016 'Thermische Energie im Hochbau', U-Wert-Grenzwerte und Heizwärmebedarf Q_h."
  - "GEG 2024 (Gebäudeenergiegesetz, Bundesgesetzblatt I 2023 Nr. 280 i. d. F. 2024), Anlage 7 (Anforderungswerte U für Dächer)."
  - "MuKEn 2014 (Mustervorschriften der Kantone im Energiebereich), Konferenz der kantonalen Energiedirektoren EnDK, Mindest-U-Werte Dach Neubau/Sanierung."
  - "DIN EN 13162:2015-04 'Wärmedämmstoffe für Gebäude – Werkmäßig hergestellte Produkte aus Mineralwolle (MW)'."
  - "DIN EN 13165:2016-09 'Wärmedämmstoffe für Gebäude – Werkmäßig hergestellte Produkte aus Polyurethan-Hartschaum (PUR/PIR)'."
  - "DIN EN 13171:2015-04 'Wärmedämmstoffe für Gebäude – Werkmäßig hergestellte Produkte aus Holzfasern (WF)'."
  - "DIN EN 13163:2017-02 'Wärmedämmstoffe für Gebäude – Werkmäßig hergestellte Produkte aus expandiertem Polystyrol (EPS)'."
  - "DIN EN 13164:2015-04 'Wärmedämmstoffe für Gebäude – Werkmäßig hergestellte Produkte aus extrudiertem Polystyrolschaum (XPS)'."
  - "DIN EN 15101-1:2019-12 'Wärmedämmstoffe für Gebäude – An der Verwendungsstelle hergestellte Wärmedämmung aus losen Zellulosefasern (LFCI) – Teil 1: Spezifikation für die Produkte vor dem Einbau'."
quellen_sekundär:
  - "Lignum (Hrsg.): Lignatec 'Geneigte Dächer in Holzbauweise', Lignum, Zürich, aktuelle Auflage, Kap. 'Wärmeschutz'."
  - "Mönck, W.; Rug, W.: Holzbau – Bemessung und Konstruktion, 16. Aufl., Beuth Verlag 2015, Kap. 'Bauphysik – Wärmeschutz'."
  - "Natterer, J.; Herzog, T.; Volz, M.: Holzbau-Atlas, 4. Aufl., Birkhäuser 2003, Kap. 'Bauphysik'."
  - "Informationsdienst Holz: 'Wärmeschutz im Holzbau', Holzbau Deutschland / DGfH, aktuelle Auflage."
  - "Wegleitung zur Norm SIA 180, Schweizerischer Ingenieur- und Architektenverein."
  - "Minergie Schweiz, Anforderungen Modul Dach/Wand (minergie.ch)."
  - "Passivhaus Institut Darmstadt, Kriterien für zertifizierte Passivhäuser."
...
quellenkonflikt: |
  **(1) Keine geschlossene Begriffsdefinition in den Anforderungs- und
  Berechnungs-Normen.** Weder DIN 4108-2:2013-02 noch DIN EN ISO
  6946:2018-03 noch SIA 180:2014 noch SIA 380/1:2016 noch das GEG 2024
  führen „Wärmedämmung" als eigenständig definierten Begriff ein. Alle
  setzen den Begriff voraus und operieren mit den abgeleiteten Grössen
  Wärmeleitfähigkeit λ (W/(m·K)), Wärmedurchlasswiderstand R = d/λ
  (m²·K/W) und Wärmedurchgangskoeffizient U = 1/(R_si + ΣR + R_se)
  (W/(m²·K)). Die einzige Norm im konsultierten Korpus, die einen
  Vokabular-Anspruch erhebt, ist **DIN EN ISO 9229:2020** „Wärmeschutz
  – Begriffe". Ihr Volltext liegt nicht im Volltext vor
  (kostenpflichtig); die Existenz und Funktion als Vokabular-Norm ist
  über ANSI Webstore und ISO OBP belegt, der konkrete Wortlaut der
  Begriffsdefinition ist über die zugänglichen Sekundärquellen nicht
  zitierbar. Konsequenz: dieser Eintrag formuliert die Begriffs-
  definition auf Basis der konsistenten Sekundärquellen-Lesart
  (Mönck/Rug, Holzbau-Atlas, Lignatec, Informationsdienst Holz) und
  verweist auf DIN EN ISO 9229 als anzustrebende Primärquelle für
  eine spätere Konsolidierung.

  **(2) Konstruktive Subtypen-Trias berufssprachlich, nicht normativ.**
  Die Trias **Zwischensparren-/Aufsparren-/Untersparrendämmung** ist
  in der DACH-Holzbau-Praxis durchgängig etabliert und wird im GEG
  2024 sowie in allen konsultierten Lehrbüchern (Mönck/Rug, Holzbau-
  Atlas, Lignatec, Informationsdienst Holz) als selbstverständliche
  konstruktive Klassifikation geführt. **Sie ist jedoch in keinem
  Normwerk (DIN 4108-2, DIN EN ISO 6946, SIA 180, SIA 380/1) als
  klassifikatorische Trias definiert**; sie tritt dort höchstens als
  Aufzählung praxiseingeführter Bezeichnungen auf, ohne
  Begriffsdefinition. Dieser Eintrag führt die Trias dennoch als
  sealed-Hierarchie (`Zwischensparrendaemmung`,
  `Aufsparrendaemmung`, `Untersparrendaemmung`), weil sie für die
  geometrische und U-Wert-Modellierung im Holzbau unverzichtbar ist
  (Wärmebrücken-Verhalten der Sparren, Berechnung nach DIN EN ISO
  6946 als homogenes oder inhomogenes Bauteil). Die fehlende
  normative Verankerung ist hier transparent dokumentiert.

  **(3) CH-DE-Asymmetrie der Bezugsrahmen und Schwellwerte.** Die
  beiden Norm-Welten unterscheiden sich zweifach. Erstens im
  Bezugsrahmen: Schweiz mit **SIA 180 + SIA 380/1 + MuKEn 2014**
  (kantonale Energiegesetze), Deutschland mit **DIN 4108-2 + DIN EN
  ISO 6946 + GEG 2024** (Bundes-GEG). Zweitens in der Strenge des
  Mindestwerts: MuKEn 2014 verlangt im Neubau einen mittleren
  U-Wert ≤ 0,17 W/(m²·K) für das Dach (Sekundärquellen-Konsens
  sager.ch, energie-zentralschweiz, EnDK); GEG 2024 verlangt für
  Steildach (Neubau und Anforderungswert bei Erneuerung)
  U ≤ 0,24 W/(m²·K) (energie-fachberater, gutex.de). Die Schweiz
  ist im Mindestwert demnach strenger als die deutsche Mindest-
  anforderung. Bei Hochwertstandards konvergieren die beiden
  Welten: Minergie (CH) und KfW-40 / Passivhaus (DE) erreichen
  beide einen Zielbereich um 0,10 – 0,15 W/(m²·K).

  Konsequenz für die Begriffsdefinition: Die konkreten U-Wert-
  Schwellen leben **nicht** in der Begriffsdefinition selbst,
  sondern in der parametrischen Validierungsfunktion
  `pruefeWaermeschutzAnforderung(uWert, norm, bauteilArt,
  massnahmenArt)` mit `WaermedaemmungsNorm`-Enum, analog zur Auslagerung in
  `klassifiziereNachStauwasser(h, norm)` an `hg_unterdach.md`.
  Damit bleibt der Begriff `Waermedaemmung` normagnostisch und
  gegen Norm-Revisionen stabil; die Primär-Lesart (CH: SIA 380/1 +
  MuKEn) und die Sekundär-Lesart (DE: GEG + DIN 4108-2) werden
  über die Funktion ausgewählt.

  **(4) Mindestwärmeschutz vs. Energieeffizienz.** DIN 4108-2
  legt mit R ≥ 1,2 m²·K/W (entsprechend U ≈ 0,74 W/(m²·K)) den
  **Mindestwärmeschutz** als Schimmelschutz- und Tauwasser-Schwelle
  fest, eine Grössenordnung über den GEG-Effizienz-Anforderungswerten.
  Mindestwärmeschutz und Energieeffizienz sind unterschiedliche
  Anforderungs-Klassen; die Validierungsfunktion muss beide trennen
  (Parameter `massnahmenArt: NEUBAU / SANIERUNG / MINDESTSCHUTZ`).

  **(5) Sommerhitzeschutz als Auswertungs-, nicht Definitionsgrösse.**
  Phasenverschiebung (typischer Zielwert ≥ 10 h, vorzugsweise 12 h)
  und Amplitudendämpfung (Zielwert 10 – 15) sind in der Bauphysik-
  Praxis etablierte Sommerhitzeschutz-Kennwerte des Aufbaus. DIN
  4108-2 Kapitel 8 regelt den sommerlichen Wärmeschutz über
  Sonneneintragskennwerte und legt **keine** expliziten
  Phasenverschiebungs-Schwellwerte fest. Die letztgenannten
  Schwellwerte sind eine **Holzbau-Praxis-Konvention** auf Basis von
  Lehrbuch- und Hersteller-Empfehlungen (Trockenbau-Ausbau,
  Holzfaser-Verbände, Informationsdienst Holz), nicht normativ. Sie
  sind **Auswertungs-Eigenschaften des Aufbaus**, nicht Bestandteil
  der Begriffsdefinition der Wärmedämmung; analog zur Trennung
  Bauteil/Klassifikator in `hg_unterdach.md`. Eine Pruef-Funktion
  `pruefeSommerhitzeschutz(aufbau, klimazone, norm)` lebt
  ausserhalb des Begriffs.

  **(6) Material-Achse orthogonal zur Subtypen-Achse.** Die
  Produkt-Normen DIN EN 13162 (Mineralwolle), 13163 (EPS), 13164
  (XPS), 13165 (PUR/PIR), 13171 (Holzfaser) und EN 15101-1
  (Zellulose) definieren die Material-Produkte mit ihren λ-Werte-
  Bereichen und Spezifikationen, **nicht** den Begriff
  „Wärmedämmung". Die Material-Wahl ist im Holzbau orthogonal zur
  konstruktiven Subtypen-Lage (Zwischen/Auf/Unter): jeder Subtyp
  kann mit jedem der Materialien realisiert werden, mit
  unterschiedlichen Eignungs-Profilen (Aufsparrendämmung verlangt
  Druckfestigkeit; Zellulose ist Einblas-spezifisch; Mineralwolle
  und Holzfaser sind universell). Konsequenz: das `Material`-Feld
  ist ein **eigenes Tupel-Element**, **nicht** ein sealed-Subtyp
  von `Waermedaemmung`. Die sealed-Hierarchie strukturiert
  ausschliesslich die geometrische Lage relativ zum Sparren.

  **(7) Oberbegriff.** Der Oberbegriff `schicht` wird parallel zu
  diesem Eintrag angelegt (`hg_schicht.md`). Der `data class
  Schicht`-Stub in `hg_dachaufbau.md` (Z. 226) ist die strukturelle
  Vorlage; sobald `hg_schicht.md` final ist, übernimmt
  `Waermedaemmung` davon das `Schicht`-Pendant als Bestandteil
  (Komposition statt Vererbung — die `Waermedaemmung`-Instanz
  **enthält** die zugeordnete `Schicht` über deren `funktion =
  WAERMEDAEMMUNG`, analog zu `Unterdach` in `hg_unterdach.md`).

  **(8) „Isolierung" als abgelehnte Benennung.** „Isolierung" ist
  umgangssprachlich weit verbreitet, im technischen Vokabular der
  DIN- und SIA-Normwelt jedoch konsequent durch „Dämmung" /
  „Wärmedämmung" ersetzt. „Isolierung" ist semantisch breiter
  (elektrische Isolation, akustische Schalldämmung, thermische
  Dämmung) und damit für den Holzbau-Begriff ungeeignet. Die
  englischen Pendants „thermal insulation" / „insulation" / „roof
  insulation" sind ebenfalls abgelehnt (kein Anglizismus in der
  Hauptdefinition; sie erscheinen ausschliesslich als Mapping-
  Ziele für DIN-EN-Norm-Bezug).

  **(9) Lokales Norm-Enum `WaermedaemmungsNorm`.** Die Norm-Aufzählung
  in den parametrischen Klassifikationen
  `klassifiziereNachUWert(uWert, norm)` und
  `pruefeWaermeschutzAnforderung(uWert, norm, bauteilArt, massnahmenArt)`
  heisst lokal `WaermedaemmungsNorm`, nicht generisch `Norm`. Damit
  kollidiert sie nicht mit den lokalen Enums `UnterdachNorm`
  (`hg_unterdach.md`) und `AbdichtungsNorm` (`hg_dachabdichtung.md`).
  Vier Werte (`SIA_232_1`, `DIN_4108_3`, `ZVDH_FACHREGEL`,
  `OENORM_B_4119`) sind dabei mit `UnterdachNorm` namensgleich, weil
  diese Holz-/Dachbau-Normen sowohl in der Unterdach- als auch in
  der Wärmedämmungs-Modellierung referenziert werden — die lokalen
  Enums bilden disjunkte oder teilweise überlappende Untermengen
  eines noch nicht angelegten gemeinsamen Norm-Korpus.
  **Folgearbeit-Trigger:** sobald mindestens zwei Bauphysik-Module
  dieselbe Norm funktional referenzieren (im aktuellen Bestand
  bereits gegeben: SIA 232/1, DIN 4108-3 in Unterdach- *und*
  Wärmedämmungs-Kontext), wird ein zentraler Eintrag `hg_norm.md`
  angelegt und `WaermedaemmungsNorm` durch eine Filter-Sicht auf
  das gemeinsame Norm-Enum ersetzt; bis dahin bleibt die lokale
  Form mit eindeutigem Klassennamen, und die wertgleichen
  Enum-Konstanten in verschiedenen lokalen Enums werden bei der
  Migration zu einem gemeinsamen Wert deduppliziert.
---

## Prosa-Definition

Eine **Wärmedämmung** ist eine Schicht eines Bauteilaufbaus, deren
funktionale Rolle die Begrenzung des Wärmestroms durch das Bauteil
ist, dadurch dass sie aus einem werkmässig oder an der
Verwendungsstelle hergestellten Stoff geringer Wärmeleitfähigkeit
mit positiver Dicke besteht und im Aufbau zwischen zwei thermisch
unterschiedlichen Halbräumen liegt.
...
1. **Funktionsklasse:** `S_{j*}.funktion = WAERMEDAEMMUNG`.
2. **Positive Dicke:** d_{j*} > Toleranzen.LAENGE_EPS.
3. **Positive Materialkennwerte:** λ > 0, ρ > 0, c_p > 0.
4. **Wärmeleitfähigkeits-Wertebereich (Plausibilität, nicht
   normativ erzwungen):** 0,015 ≤ λ ≤ 0,070 W/(m·K) deckt den
   gesamten Wertebereich der Produkt-Normen DIN EN 13162–13171
   ab. Werte ausserhalb erzeugen eine Plausibilitäts-Warnung,
...
- **Existenz:** Für jeden Dachaufbau A mit mindestens einer
  Schicht der Funktionsklasse WAERMEDAEMMUNG, ein zugeordnetes
...
- **Eindeutigkeit der Wärmedämmungs-Schicht im Aufbau:** Die
  ...
  **mehrere** Schichten der Funktionsklasse WAERMEDAEMMUNG
  enthält. Im typischen Sanierungs-Aufbau (Zwischensparren +
  Untersparrendämmung; Zwischensparren + Aufsparrendämmung)
...
- **Trivialität der Subtyp-Lage-Bedingung:** Die Bedingung (6) ist
  ...
  Schicht in 𝒮 (z. B. Flachdach mit alleiniger Abdichtung) ist
  T = ∅; dann ist die Bedingung trivial erfüllt und σ = SONSTIGE
  ist die zulässige Wahl.

## Erläuterung (nicht normativ)

Die Wärmedämmung ist im modernen Holzbau die **dominierende Schicht
des Dachaufbaus, gemessen in Dicke und bauphysikalischer Wirkung**.
Während eine Eindeckung wenige Zentimeter dick ist und eine
Dampfbremse eine Folie unter einem Millimeter, baut die
Wärmedämmung typisch 200 bis 400 mm Schichtdicke auf — bei
Passivhäusern und Minergie-P-Bauten bis 500 mm und mehr. Sie
bestimmt zusammen mit dem U-Wert die Energieeffizienz des
Gebäudes und über die volumetrische Wärmekapazität ρ·c_p den
sommerlichen Hitzeschutz des ausgebauten Dachgeschosses.

### Die konstruktive Subtypen-Trias

Im Holzbau ist die geometrische Lage der Wärmedämmung relativ zur
Sparren-Tragebene konstruktiv und bauphysikalisch entscheidend.
Drei Subtypen sind berufssprachlich durchgängig etabliert:
...
Die Materialwahl ist von der konstruktiven Lage **unabhängig**: jeder
Subtyp kann mit jedem der Materialien realisiert werden, mit
unterschiedlichen Eignungs-Profilen. Für die Modellierung wird die
Material-Achse als getrenntes Feld geführt (siehe Implementierungs-
hinweis); für die Begriffsdefinition ist sie als enum-wertige
Tupel-Komponente m ∈ ℳ in der Konsistenzbedingung (3) verankert.
...
Die Schweiz folgt **SIA 380/1 + MuKEn 2014** als Bezugsrahmen,
Deutschland **GEG 2024 + DIN 4108-2**. Die Mindestanforderungen
(Sekundärquellen-Konsens) trennen sich asymmetrisch:
...
- DIN EN 15101-1:2019-12 (Zellulose, an Verwendungsstelle
  hergestellt).
