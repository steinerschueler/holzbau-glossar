...
abgrenzung_zu: [strebe, fussband, knagge, raehm, pfette, firstpfette, mittelpfette, fusspfette, unterzug, staender, pfosten, mann, andreaskreuz, kniestrebe, zugband, bauteil]
status: entwurf
...
quellen_primär:
  ...
  - "Thesaurus Traditioneller Holzbau (TTH), RWTH Aachen, Hierarchie-Facette 1922 'Fachwerk-Bauteile': Kopfband in der Unter-Facette 'Band (Bauteil)' geführt, gleichrangig zum Fußband; nicht unter Strebe. [direkt]"
  - "Wikipedia, Lemma 'Kopfband' (de.wikipedia.org/wiki/Kopfband), Wortlaut: 'Ein Kopfband (auch Bug oder Kopfbüge) ist eine Strebe, die vom Zimmerer zwischen einem horizontalen Holz […] und einem vertikal stehenden Holz […] eingesetzt wird, um eine Versteifung der Konstruktion zu erzielen.' [direkt]"
  - "BauNetz Wissen, Glossar-Holz, Lemma 'Kopfband' (baunetzwissen.de/glossar/k/kopfband-6629384): 45°-Default, Spannweiten-Verkürzung des darüberliegenden horizontalen Bauteils, Längsaussteifungs-Funktion in Träger-Richtung. [einsicht: snippet]"
quellen_sekundär:
  ...
  - "Lignum (Hrsg.): Holzbautabellen HBT 1 (2024). Lignum, Zürich. Begriffsregister 'Kopfband' (Volltext nicht zugänglich, Verlags-Schaufenster). CH-Praxis-Verteilung in §H der Recherche dokumentiert."
  - "Mönck, W.; Rug, W.: Holzbau – Bemessung und Konstruktion. 16. Aufl., Beuth, Berlin 2015, Kap. 'Wandscheiben' und 'Knotenausbildung'."
  - "Natterer, J.; Herzog, T.; Volz, M.: Holzbau-Atlas. 4. Aufl., Birkhäuser, Basel 2003, Kap. 'Wandbau' und 'Fachwerk'."
  - "Gerner, M.: Fachwerk – Instandsetzung, Sanierung, Neubau. DVA, 7. Aufl. 2007, Glossar 'Kopfband', 'Bug', 'Achselband'."
  - "Großmann, R.: Konstruktionen des deutschen Fachwerkbaus. 1987 — Primärquelle der TTH-Lemmata Kopfband (S. 70) und Strebe (S. 72); nicht direkt eingesehen, über TTH zitiert."
  - "Wikipedia, Lemma 'Mann (Fachwerk)' — Bündel-Aussteifungs-Figuren mit Kopfband-Mitgliedschaft (Mannfigur, Halber Mann, Wilder Mann, Hessenmann, Schwäbisches Männle)."
  - "Wikipedia, Lemma 'Knagge' — dreieckiges Vollholz als Konsole; Abgrenzung zum Kopfband."
  - "bauredakteur.de 'Fachwerk – Begriffe und Konstruktion': funktionale Trennung Strebe / Kopfband / Fußband."
  - "baubeaver.de 'Fachwerkhaus': Kopfband-Praxis, Bug- und Kopfbüge-Synonymie."
...
quellenkonflikt: |
  ...
  **(1) Wikipedia subsumiert Kopfband unter Strebe; TTH nicht.**
  Wikipedia/Kopfband formuliert wörtlich: „Ein Kopfband (auch Bug
  oder Kopfbüge) ist **eine Strebe**, die vom Zimmerer zwischen
  einem horizontalen Holz […] und einem vertikal stehenden Holz
  […] eingesetzt wird". Wikipedia/Strebe ergänzt: „In einem Winkel
  von meistens 45° verlaufende Streben werden auch Fußband und
  Kopfband genannt." Der Thesaurus Traditioneller Holzbau (TTH,
  RWTH Aachen, Tier Mittel-Hoch) widerspricht: TTH ID 832 „Kopfband"
  ist ein **Deskriptor in der Unter-Facette „Band (Bauteil)"** der
  Hierarchie-Facette 1922 „Fachwerk-Bauteile", **gleichrangig zum
  Fußband** und **nicht** als Sub-Begriff der Strebe (TTH ID 903)
  geführt. Großmann 1987 S. 70 (TTH-Primärquelle) trennt beide
  Begriffe terminologisch. Die strukturelle Trennung ist
  konstruktiv tragbar: das Kopfband hat einen **Pfosten-Kopf-Anker**
  und einen **horizontalen Längsholz-Anker**, die Strebe hat
  typisch zwei horizontale Anker oder einen Pfosten-Anker im
  Pfosten-Fuß-/Mittel-Bereich.

  Eigene Festlegung: die TTH-Linie wiegt schwerer (höherer Quellen-
  rang, saubere Anker-Trennung, klare Funktions-Trennung). Das
  Kopfband ist in diesem Glossar eine **eigene Bauteilrolle**,
  Geschwister der Strebe unter `bauteil`, nicht Sub-Lesart. Die
  Anker-Bedingung (Bedingung 5 unten: Pfosten-Endpunkt **am
  Pfosten-Kopf**) ist die strukturelle Trennlinie.
  ...
  **(2) „Bug" und „Kopfbüge" — Synonyme, keine eigenen Einträge.**
  ...
  (Holzbau) irrelevant. Die Auftrags-Hypothese „Bug ist im
  Holzbau-Korpus mehrdeutig" ist damit **falsifiziert**.

  Eigene Festlegung: **Bug, Kopfbüge, Achselband sind in
  `synonyme:` geführt**, kein eigener Glossareintrag. Die
  CH-Praxis-Verteilung (siehe Punkt 3) ändert die Synonymie
  nicht.

  **(3) CH/DE-Asymmetrie der Begriffsverwendung.** Im **DE/AT-
  Korpus** ist Kopfband breit etabliert (TTH, Wikipedia, BauNetz,
  Gerner, Praxis-Blogs); „Bug" ist regional süddeutsch/
  österreichisch. Im **CH-Korpus** ist Kopfband **wenig belegt**:
  weder Lignum (Holz A–Z / Konstruktion) noch architektvergleich.ch
  noch andere CH-Quellen führen den Begriff im Wand-Aussteifungs-
  Glossar prominent. „Bug" ist im CH-Korpus **nicht belegt**.
  Vermutung (snippet-basiert, nicht Norm): die CH-Praxis verwendet
  „Strebe" als breiteren Sammelbegriff oder ersetzt die Kopfband-
  Funktion durch Beplankungs-Aussteifung im modernen Holzrahmen-/
  Holztafelbau.

  Eigene Festlegung: Die Wurzel-Benennung ist trotz CH-Negativ-
  Evidenz **„Kopfband"** (deutsch, DACH-übergreifend etabliert).
  ...
  **(5) „Kopfwinkel" / „Kopfwinkelholz" — korpus-unsicher,
  ...
  `hg_riegel.md` Z. 311 als Sturzriegel-Synonym auf und wird in
  einigen Praxis-Glossaren teils synonym zum Kopfband, teils
  synonym zur Knagge verwendet. Korpus-Befund: keine TTH-
  Lemmatisierung, keine SIA/DIN-Verankerung; uneinheitliche
...
Ein **Kopfband** ist eine Bauteilrolle in einer Wand, deren
Bauteilachse als gerades Stab-Bauteil in der Wandebene
**diagonal** zwischen dem **Kopf** eines lotrechten Bauteils
(Pfosten/Ständer) und einem über diesem verlaufenden
**horizontalen Längsholz** (Rähm, Pfette oder Unterzug)
gespannt ist und die Pfosten-Längsholz-Verbindung gegen
horizontale Lasten versteift sowie die Spannweite des
darüberliegenden Längsholzes durch ein zusätzliches Auflager
verkürzt.
...
4. **Zwei-Anker-Bedingung Pfosten + Längsholz**: Genau eines
   der Endpunkte p_a, p_e liegt auf der Pfosten-Bauteilachse
   a(P) und das andere auf der Längsholz-Bauteilachse a(H), je
   bis auf Toleranz ε_L. Ohne Beschränkung der Allgemeinheit
   sei p_P ∈ {p_a, p_e} der Pfosten-Endpunkt und p_H der
   Längsholz-Endpunkt:
   ```
   dist(p_P, a(P)) ≤ ε_L  ∧  dist(p_H, a(H)) ≤ ε_L.
   ```

5. **Pfosten-Kopf-Anker** (strukturelle Trennlinie zur Strebe):
   Der Pfosten-Anker-Endpunkt liegt **am Pfosten-Kopf**,
   ```
   |p_P.z − z_max^P| ≤ ε_L · 3,
   ```
   d. h. der Pfosten-Endpunkt befindet sich am oberen Ende der
   Pfosten-Bauteilachse. Diese Bedingung trennt das Kopfband
   strukturell von der Strebe (`hg_strebe.md` Bedingung 5
   verlangt komplementär `p_P.z ≤ z_max^P − ε_L · 3` für die
   Pfosten-Strebe-Klassifikation) und vom Fußband (welches
   `|p_P.z − z_min^P| ≤ ε_L · 3` verlangt; Folgearbeit-Trigger
   `hg_fussband.md`).

6. **Aufwärts-Orientierung der Bauteilachse vom Pfosten zum
   Längsholz**: Der Längsholz-Endpunkt liegt höher als der
   Pfosten-Endpunkt,
   ```
   p_H.z + ε_L > p_P.z,
   ```
   d. h. die Diagonale steigt vom Pfosten-Kopf aufwärts gegen
   das darüberliegende Längsholz an. Diese Bedingung ist konsistent
   mit der Funktion „Spannweiten-Verkürzung des Längsholzes"
   (das Längsholz liegt **über** dem Pfosten-Kopf).
...
- **Existenz**: Für jedes Stabbauteil mit positiver Achsenlänge,
  ...
  Diagonal-Neigung, einem Endpunkt am Kopf eines lotrechten
  Bauteils und dem anderen auf einem darüberliegenden
...
- **Abgrenzung zur Strebe**: Bedingung 5 (Pfosten-Endpunkt am
  ...
  (siehe `hg_strebe.md` Bedingung 5). Die Grenzfälle (Pfosten-
...
- **Faktor 3 in der Pfosten-Kopf-Toleranz**: Der Schwellwert
  ...
  Position ist eine topologische Lage (Endpunkt der Bauteilachse,
  konstruktive Anker-Stelle), nicht eine reine Geometrie-Marke;
  sie muss Bauteil-Toleranzen (Zapfen-Tiefe, kleine Konstruktions-
  Versätze, Abbund-Toleranzen im historischen Fachwerk) tolerieren.
  Der Faktor 3 ist konservativ konstant gewählt; eine eigene
  Konstante `Toleranzen.TOPOLOGISCHE_ANKER_EPS` ist Folgearbeit-
...
- **Nicht-Zirkularität**: Die Definition stützt sich nur auf
  ...
  Wand- und Dach-Längsholz-Geschwister (`staender`/`pfosten`,
  `raehm`, `pfette`). Forward-Verweise (`strebe` als Welle-10-
  Geschwister, `fussband`, `knagge`, `unterzug`, `mann`,
  `andreaskreuz`, `kniestrebe`, `zugband`) sind nach
  HG_KONVENTIONEN.md §6 zulässig.

## Erläuterung (nicht normativ)

Das Kopfband ist im DACH-Holzbau die **diagonale Eckaussteifung**
zwischen einem Pfosten-Kopf und einem über diesem verlaufenden
horizontalen Längsholz (Rähm, Pfette, Unterzug). Es ergänzt das
rechtwinklige Pfosten-Längsholz-Eck durch ein **kleines, festes
Dreieck**, das die Verbindung gegen Verdrehen aussteift und
zugleich das Längsholz an einer zusätzlichen Stelle unterstützt.

### Funktion

Das Kopfband leistet zwei konstruktive Aufgaben gleichzeitig:

1. **Eckaussteifung**: die Pfosten-Längsholz-Verbindung gewinnt
...
2. **Spannweiten-Verkürzung**: das darüberliegende Längsholz
   ...
   sinkt, die Durchbiegung sinkt entsprechend (BauNetz-Snippet:
   „Kopfbänder verkürzen die Spannweite der darüber liegenden
   Bauteile und vermindern somit deren Durchbiegung").

Statisch arbeitet das Kopfband typisch als **Druckstrebe** (bei
horizontaler Last auf den Pfosten) und/oder als Zug-Diagonale
(bei umgekehrtem Lastrichtungs-Wechsel). In gut ausgesteiften
Wänden werden Kopfbänder **paarweise beidseitig** am Pfosten-
Kopf angeordnet (Wikipedia/Kopfband: „Kopfbänder sollten bei
Zwischenstielen immer von beiden Seiten angeordnet werden"),
um die wechselnde Windrichtung abzudecken.

### Geometrie und Größe

Das Kopfband ist typisch **kurz** (Länge 40–80 cm im
historischen Fachwerk) und in **~45°** zur Lotachse geneigt
(Praxis-Range 35–55°; kein Norm-Wert). Damit unterscheidet es
sich klar von der **Strebe**, die typisch über mehr als ein
Gefach reicht und in 60–80° steiler steht (baubeaver: 70–75°
Praxis-Empfehlung).

Die mathematische Definition fixiert den Winkel **nicht** auf
45° — die Trennung von der Strebe erfolgt allein über die
**Anker-Lage am Pfosten-Kopf** (Bedingung 5), nicht über den
Winkel.
...
- **Oberer Anschluss am Längsholz**: meistens **Zapfen**
  (Holzzapfen am Kopfband-Ende, eingelassen in Zapfenloch der
...
- **Unterer Anschluss am Pfosten/Ständer-Kopf**: ebenfalls
  ...
  Verbindung die kritische Stelle; die **Knagge** ist die
  konstruktive Alternative, die ohne Stab-Bauteil im Wandgefüge
  auskommt.
...
- **Strebe** (`strebe`, Welle-10-Geschwister): diagonales
  ...
  einem Pfosten-Anker im Pfosten-**Fuß**- bzw. -**Mittel**-
  Bereich. Wikipedia subsumiert Kopfband als „Strebe in
...
- **Oberbegriff**: `bauteil`. Das Kopfband ist ein Bauteil mit
  der zusätzlichen Rolle „Kopfband" und den geometrischen
